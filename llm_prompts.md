...
- Prefer conviction and evidence quality over quantity. Fewer strong picks beat
  more mediocre ones. Holding cash is a valid, sometimes wise, outcome — if
  nothing clears the bar, return an empty picks list and say why.
...

{
  ...
  "cash_held_inr": number,          // deliberately un-deployed cash
